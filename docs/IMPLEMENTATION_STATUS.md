...
- **Hâlâ eksik**: `PackageExplorer` bileşeni canonical veri kabul etmiyor (ayrı `CanonicalPackageCard` kullanılıyor). Compare'in donanım/kronik-sorun kıyası hâlâ statik/legacy.
