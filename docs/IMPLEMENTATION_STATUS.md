...
- `GET /catalog/meta` artık: 31 marka, 130 model, 97 nesil, 111 motor, 28 şanzıman, 134 paket, 53 donanım, 55 araç varyantı, 20 sorun arketipi, 740 sorun-kapsam eşleşmesi, 14 bakım kalemi, 31 referans değer, 8 değerleme faktörü.
