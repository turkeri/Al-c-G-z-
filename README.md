...
3. **Araç Veritabanı** (`src/data/vehicles.json`) — 36 marka, 125 model/nesil kaydı, 140+ motor varyantı. Türkiye'de en çok ikinci el ilanı bulunan segmentlere odaklanır (araştırma: en çok satılan ikinci el marka/modeller, nesil bazlı kronik sorun kaynakları — şikayetvar, forum ve ikinci el alım rehberleri). Aynı nameplate'in farklı nesilleri ayrı kayıtlar olarak tutulur (örn. **Golf**, **Golf (Mk6)**, **Golf (Mk5)**; **Clio**, **Clio (Clio 3)**; **Megane**, **Megane (3. Nesil)**; **Fiat Albea**, **Tofaş Şahin** gibi 2000 öncesi/bütçe segmenti dahil), çünkü kronik sorunlar ve güvenilirlik nesilden nesile değişir. Her motor için güvenilirlik puanı, kronik sorunlar, kontrol listesi, **ortalama yakıt tüketimi (L/100km)** ve referans fiyat verisi bulunur. **Not:** Bu veri, genel otomotiv bilgisi + web araştırmasının birleşimidir; sahibinden.com'dan canlı/otomatik çekilen bir veri seti değildir ve resmi fabrika (WLTP) rakamlarını garanti etmez.
