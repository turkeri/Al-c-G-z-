...
export function adminNavigation(permissions) { return [['Genel Bakış','/admin','admin:access'],['Katalog','/admin/katalog','catalog:read'],['Duyurular','/admin/duyurular','announcement:read'],['Ayarlar','/admin/ayarlar','settings:read'],['Denetim Kaydı','/admin/denetim-kaydi','audit:read']].filter(([, , permission]) => can(permissions, permission)) }
