...
export const createAnnouncement = (payload) => request('/admin/announcements', 'POST', payload)
export const updateAnnouncement = (id, payload) => request(`/admin/announcements/${id}`, 'PUT', payload)
export const publishAnnouncement = (id) => request(`/admin/announcements/${id}/publish`, 'POST')
export const unpublishAnnouncement = (id) => request(`/admin/announcements/${id}/unpublish`, 'POST')
export const archiveAnnouncement = (id) => request(`/admin/announcements/${id}/archive`, 'POST')
